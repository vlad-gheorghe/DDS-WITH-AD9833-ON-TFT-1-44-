...
void setup() { 
  ...
  tft.drawFastVLine(10, tft.height()-55, 4, GREY);         // Display 'static' cosmetic text.
  tft.drawFastVLine(30, tft.height()-55, 4, GREY);
  tft.drawFastVLine(37, tft.height()-55, 4, GREY);
  tft.drawFastVLine(78, tft.height()-55, 4, GREY); 
  tft.drawFastVLine(85, tft.height()-55, 4, GREY); 
  tft.drawFastVLine(124, tft.height()-55, 4, GREY); 
  
  tft.drawFastHLine(10, tft.height()-52, 20, GREY); 
  tft.drawFastHLine(37, tft.height()-52, 42, GREY); 
  tft.drawFastHLine(85, tft.height()-52, 40, GREY); 
  ...
  tft.setCursor(15,95 );
  tft.setTextSize(1);
  tft.drawFastHLine(5, 93, 150, GREY);
  tft.setTextColor(GREY);
  tft.println("AD9833 0 Hz to 10 MHz ");
...
void updateDisplay() {
  ...
  tft.fillRect(40, 30, 120, 12, BLACK);            // Clear text.
  
  tft.setTextColor(YELLOW);
  tft.setCursor(55, 30);
  tft.setTextSize(1); 
  switch (waveType) {
    case SINE: tft.print("  Sinus"); break;
    case SQUARE: tft.print("Dreptunghi"); break;
    case TRIANGLE: tft.print("Triunghi"); break;
  }
...
void format(unsigned long value) {
  ...
  for (int i=6; i>=0; i--) {
    ...
    incr == j ? tft.setTextColor(BLUE): tft.setTextColor(GREEN);
    tft.print(digit);
